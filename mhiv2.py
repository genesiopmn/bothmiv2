...
def fmperda(novo_saldo,percenloss):
    if novo_saldo > saldohoje:
        mperda = round(novo_saldo / 100 * percenloss,2)
...
API = IQ_Option('genesiopmn@gmail.com', senha)
...
bamode = str(input(' Indique o modo REAL ou PRACTICE: ')).upper()
...
martingale = int(2) # = int(input(' Indique a quantidade de martingales: '))
martingale += 1
stop_loss = float(input(' Indique o valor de Stop Loss: '))
stop_gain = float(input(' Indique o valor de Stop Gain: '))
percengain = int(input(' Indique a meta diaria de ganho percentual: '))
percenloss = int(input(' Indique a percentual de perda tolerado:'))
sensibilidade = int(input("Escolha a sensibilidade da regra: \n1=MAIS - MAIS PRECISAO\n2=MENOS - MENOS PRECISAO \n"))
...
def informe(desligameta):
    if novo_saldo >= meta_perda and novo_saldo <= meta_ganho and desligameta == 'SIM':
        alcance_meta(novo_saldo, meta_perda, meta_ganho, desligameta)
                                ...
                                if status:
                                    ...
                                    if valor > 0:
                                        ...
                                        if novo_saldo > saldohoje:
                                            ...
                                            mperda = (novo_saldo / 100 * percenloss)
                                            meta_perda = (novo_saldo - mperda)
                                        else:
